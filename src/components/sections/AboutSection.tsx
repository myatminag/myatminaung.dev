...
const AboutSection = () => {
  ...
  return (
    <section
      id="about"
      ref={aboutSectionRef}
      className="my-10 grid min-h-screen place-content-center bg-[#292d36] lg:my-0"
    >
      <div className="container">
        <p className="mb-8 text-center text-heading text-xl font-medium text-main-300 lg:mb-16 lg:text-3xl">
          About Me 👨‍💻
        </p>
        <div className="flex flex-col items-center justify-center gap-y-6 lg:flex-row lg:items-start lg:gap-x-12">
          <div className="flex-1 space-y-6">
            <div className="space-y-3">
              <p className="w-full text-justify tracking-wide text-primary-100 dark:text-secondary-100">
              ...
              <p className="w-full text-justify tracking-wide text-primary-100 dark:text-secondary-100">
                ...
                frameworks, my true passion lies in the seamless fusion of
                design and functionality.
              </p>
              <p className="text-black-100 text-justify tracking-wide dark:text-secondary-100">
            ...
            <div className="space-y-3">
              <p className="text-heading font-medium text-primary-100 dark:text-secondary-100">
                Work Experience 💼
              </p>
              <div className="flex w-full items-center justify-start">
                <div className="grid w-full grid-cols-1 gap-4">
                  <div className="relative flex max-w-2xl items-start gap-x-4 before:absolute before:bottom-0 before:left-6 before:top-[3rem] before:h-[calc(70px)] before:w-[1px] before:bg-zinc-200 dark:before:bg-zinc-800 lg:gap-x-6">
                    <div className="grid min-h-[50px] min-w-[50px] place-content-center rounded-lg bg-zinc-200 text-primary-100 dark:bg-primary-200 dark:text-secondary-100">
                      <svg
                    ...
                    <div className="w-full">
                      <p className="font-medium text-primary-100 dark:text-secondary-100">
                        ILBC
                      </p>
                      <p className="mb-1 text-primary-100 dark:text-secondary-100">
                        Frontend Developer
                      </p>
                      <time className="text-black-100 font-mono text-sm dark:text-secondary-100">
                        Oct 2023 -{' '}
                  ...
                  <div className="relative flex max-w-2xl items-start gap-x-4 lg:gap-x-6">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-black-100 mb-1 dark:text-secondary-100">
                        Frontend Developer
                      </p>
                      <time className="text-black-100 font-mono text-sm dark:text-secondary-100">
                        Oct 2022 - Oct 2023
          ...
          <aside className="flex flex-col items-start space-y-3 lg:w-[400px] lg:items-center">
            ...
            <div className="flex flex-col items-start gap-y-2 lg:w-[300px]">
              ...
              >
                <IconPhone className="text-black-100 w-4 dark:text-secondary-100" />
                <p className="text-black-100 text-sm dark:text-secondary-100">
                  +959427274346
                </p>
              </Link>
              <Link
                ...
                className="flex w-full items-center gap-x-3 rounded border border-zinc-200 px-4 py-2 transition-all duration-500 dark:border-zinc-700"
              >
                <IconMail className="text-black-100 w-4 dark:text-secondary-100" />
                <p className="text-black-100 text-sm dark:text-secondary-100">
