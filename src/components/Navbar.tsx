      ...
      <div className="container flex items-center justify-between">
        ...
        <div className="relative flex items-center gap-x-3 lg:hidden">
          ...
          {pathname.startsWith('/blogs') ? (
            <Link
              href="/"
              className="rounded-full border-secondary-300 bg-secondary-300 p-2 dark:border-primary-200 dark:bg-primary-200"
            >
              <IconBackArrow className="dark:text-secondary-400 swap-on h-5 w-5 fill-current text-secondary-200 dark:text-primary-300" />
            </Link>
          ) : (
            <>
