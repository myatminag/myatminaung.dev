---
title: 'Operators in JavaScript: Understanding Arithmetic Operators.'
date: 2024-02-12
...
Exponentiation is the process of raising the base number to the power of another. It can be read as " _x_ " to
the power of " _y_ ". We use " \*\* " for this operator in JavaScipt.
